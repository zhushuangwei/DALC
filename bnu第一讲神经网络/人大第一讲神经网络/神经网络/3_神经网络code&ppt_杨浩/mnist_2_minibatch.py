...
#1.5、训练模型
modelfit1 = model1.fit(X_train, Y_train,verbose=2,batch_size=420000,nb_epoch=20) 
score1 = model1.evaluate(X_test,Y_test,verbose=0)

print('Total loss on Testing Set:',score1[0])
print('Accuracy of Testing Set:',score1[1])

#2、神经网络-对比-minbatch的batch_size=100
...
plt.ylabel("Accuracy")
plt.title("Training")
plt.legend(('nobatch','','minibatch'),bbox_to_anchor=(1,0.5))
plt.show()
